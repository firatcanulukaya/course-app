...
const DeleteModal = ({handleDelete, isActive, onClose}) => {
    return(
        <div className={"studentModal "+ (isActive && "active")}>
            ...
            <div className="studentModalContent">
                    ...
                    <div className="row">
                        <div className="col">
                            <p className="studentModalContentP">
                                ...
                                deletes the student from the our database.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="studentModalfooter">
                    <ModalFooterBtn bgColor="#fff" textColor="#374151" isStroke={true} strokeColor="#E5E7EB" onClick={() => onClose()}>
                        Cancel
                    </ModalFooterBtn>
